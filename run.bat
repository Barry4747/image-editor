...
start cmd /k "cd model_service && call C:/Users/Bartek/Desktop/ImageGenerator-main\venv310\Scripts\activate.bat && uvicorn main:app --reload --port 8001 --log-level debug"
